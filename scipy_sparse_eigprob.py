...
def solve_eigprob(n):
    ...
    return ((t1b-t1a)/N_iter, (t2b-t2a)/N_iter)
...
for i, n in enumerate(N):
    time_eig, time_sparse_eigsh = solve_eigprob(n)
    print(f'{n}x{n} matrix: {time_eig:.3f} seconds and {time_sparse_eigsh:.3f} seconds')
